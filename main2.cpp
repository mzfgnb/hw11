...
private:
    ...
    int step;
    deque<float> numbers;
    deque<float> secondContainer;
    deque<float> thirdContainer;
    bool spaceWasPressed;
    bool rWasPressed;

public:
    ProgramManager() : window(sf::VideoMode(800, 600), "Контейнерные классы"), 
                      currentProgram(1), needUpdate(true), step(0),
                      spaceWasPressed(false), rWasPressed(false) {
        ...
        while (window.pollEvent(event)) {
            ...
            if (event.type == sf::Event::KeyPressed) {
                ...
                if (event.key.code == sf::Keyboard::Num3) {
                    currentProgram = 3;
                    needUpdate = true;
                    step = 0; // Сброс шагов при переходе
                    numbers.clear();
                ...
                if (event.key.code == sf::Keyboard::Space && currentProgram == 3) {
                    spaceWasPressed = true;
                }
                if (event.key.code == sf::Keyboard::R && currentProgram == 3) {
                    rWasPressed = true;
                }
            }
        }
    ...
    void update() {
        ...
        if (currentProgram == 3) {
            cout << "ПРОБЕЛ - следующий шаг, R - перезапуск программы 3" << endl;
        }
    }
    ...
    void updateProgram3() {
        ...
        // Инициализация при первом шаге
        if (step == 0 && numbers.empty()) {
            for (int i = 0; i < 8; ++i) {
...
int main() {
    ...
    cout << "ESC - выход" << endl;
    cout << "В программе 3: ПРОБЕЛ - следующий шаг, R - перезапуск" << endl;
    cout << "==============================================" << endl;
